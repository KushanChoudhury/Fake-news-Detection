...
with open('/content/drive/MyDrive/Fake news detection _dataset/tokenizer.pkl', 'wb') as file:
...
model.save('/content/drive/MyDrive/Fake news detection _dataset/model.h5')